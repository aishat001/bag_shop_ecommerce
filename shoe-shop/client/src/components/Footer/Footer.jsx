...
const Footer = () => {
    return (
        <div className='bg-black text-white py-5 flex flex-col gap-8 items-center w-[100vw] relative bottom-[0] border-1'>
            ...
            <div className='text-center py-5'>
                <h2>Business name ©, 2023. All Rights Reserved</h2>
